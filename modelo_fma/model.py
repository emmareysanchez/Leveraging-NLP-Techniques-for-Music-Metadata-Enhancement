...
input_size = (3, 128, 128)  # Ajusta el tamaño según el tamaño de los espectrogramas generados
num_classes = 16  # Número de géneros seleccionados en FMA
batch_size = 32
...
class MusicGenreDataset(Dataset):
    def __init__(self, data_dir, transform=None):
        ...
        self.image_paths = []
        self.labels = []
        # Lista de géneros agrupados en FMA
        self.genres = [
            'Rock', 'Pop', 'Metal', 'Folk', 'Jazz', 'Punk', 'Hip-Hop/Rap', 
            'Electronic', 'R&B/Soul', 'Classical', 'Country/Americana', 'World'
        ]
...
class MusicGenreClassifier(nn.Module):
    def __init__(self, num_classes):
        ...
        # Ajusta el tamaño del input de fc1 en función de tu arquitectura
